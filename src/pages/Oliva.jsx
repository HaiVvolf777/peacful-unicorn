    ...
    return (
      ...
      />
        ...
        />
            ...
            <div className="text-purple-400 body-font overflow-hidden">
                <div className="container px-5 py-2 mx-auto">
                    <div className="lg:w-4/5 mx-auto flex flex-wrap">
                        <div className="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
                            <h2 className="text-md font-Belmont font-bold title-font text-pink-500 tracking-widest">Peaceful Unicorn</h2>
                            <h1 className="text-pink-500 text-3xl title-font font-medium mb-4">Oliva</h1>
                            <div className="flex mb-4">
                                <a
                                    className="flex-grow text-zinc-200 border-b-2 border-zinc-200 py-2 text-lg px-1 hover:border-pink-500 hover:text-pink-500">Stats</a>

                            </div>
                            <div className='font-bold'>
                            <div className="flex py-2">
                                <span className="text-purple-600">Hp</span>
                                <span className="ml-auto text-zinc-200">29</span>
                            </div>
                            <div className="flex border-t border-purple-400 py-2">
                                <span className="text-purple-600">Strength</span>
                                <span className="ml-auto text-zinc-200">93</span>
                            </div>
                            <div className="flex border-t border-purple-400 py-2">
                                <span className="text-purple-600">Defence</span>
                                <span className="ml-auto text-zinc-200">48</span>
                            </div>
                            <div className="flex border-t border-purple-400 py-2">
                                <span className="text-purple-600">Heal</span>
                                <span className="ml-auto text-zinc-200">81</span>
                            </div>
                            <div className="flex border-t border-purple-400 py-2">
                                <span className="text-purple-600">Attack</span>
                                <span className="ml-auto text-zinc-200">31</span>
                            </div>
                            <div className="flex border-t border-purple-400 py-2">
                                <span className="text-purple-600">Acceleration</span>
