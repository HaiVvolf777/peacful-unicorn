    ...
    return (
      ...
      />
        ...
        />
            ...
            <div className="text-pink-300 body-font overflow-hidden">
                <div className="container px-5 py-2 mx-auto">
                    <div className="lg:w-4/5 mx-auto flex flex-wrap">
                        <div className="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
                            <h2 className="text-md font-Belmont font-bold title-font text-pink-600 tracking-widest">Peaceful Unicorn</h2>
                            <h1 className="text-pink-600 text-3xl title-font font-medium mb-4">Unkrainicon</h1>
                            <div className="flex mb-4">
                                <a
                                    className="flex-grow text-zinc-200 border-b-2 border-zinc-200 py-2 text-lg px-1 hover:border-pink-600 hover:text-pink-600">Stats</a>

                            </div>
                            <div className='font-bold'>
                            <div className="flex py-2">
                                <span className="text-pink-300">Hp</span>
                                <span className="ml-auto text-zinc-200">29</span>
                            </div>
                            <div className="flex border-t border-pink-300 py-2">
                                <span className="text-pink-300">Strength</span>
                                <span className="ml-auto text-zinc-200">93</span>
                            </div>
                            <div className="flex border-t border-pink-300 py-2">
                                <span className="text-pink-300">Defence</span>
                                <span className="ml-auto text-zinc-200">48</span>
                            </div>
                            <div className="flex border-t border-pink-300 py-2">
                                <span className="text-pink-300">Heal</span>
                                <span className="ml-auto text-zinc-200">81</span>
                            </div>
                            <div className="flex border-t border-pink-300 py-2">
                                <span className="text-pink-300">Attack</span>
                                <span className="ml-auto text-zinc-200">31</span>
                            </div>
                            <div className="flex border-t border-pink-300 py-2">
                                <span className="text-pink-300">Acceleration</span>
                                <span className="ml-auto text-zinc-200">14</span>
                            </div>
                            <div className="flex border-t border-pink-300 py-2">
                                <span className="text-pink-300">Pace</span>
