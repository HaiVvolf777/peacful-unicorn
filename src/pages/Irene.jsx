                ...
                <div className="container px-5 py-2 mx-auto">
                    <div className="lg:w-4/5 mx-auto flex flex-wrap">
                        <div className="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
                            <h2 className="text-md font-Belmont font-bold title-font text-yellow-400 tracking-widest">Peaceful Unicorn</h2>
                            <h1 className="text-yellow-400 text-3xl title-font font-medium mb-4">Unkrainicon</h1>
                            <div className="flex mb-4">
                                <a
                                    className="flex-grow text-zinc-200 border-b-2 border-zinc-200 py-2 text-lg px-1 hover:border-yellow-400 hover:text-yellow-400">Stats</a>
