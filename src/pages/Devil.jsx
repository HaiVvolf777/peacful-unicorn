                ...
                <div className="container px-5 py-2 mx-auto">
                    <div className="lg:w-4/5 mx-auto flex flex-wrap">
                        <div className="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
                            <h2 className="text-md font-Belmont font-bold title-font text-red-600 tracking-widest">Peaceful Unicorn</h2>
                            <h1 className="text-red-600 text-3xl title-font font-medium mb-4">Unkrainicon</h1>
                            <div className="flex mb-4">
                                <a
                                    className="flex-grow text-zinc-200 border-b-2 border-zinc-200 py-2 text-lg px-1 hover:border-red-600 hover:text-red-600">Stats</a>
                            ...
                            <div className='font-bold'>
                                ...
                                <div className="flex border-t border-white py-2">
                                    <span className="text-zinc-300">Defence</span>
                                    <span className="ml-auto text-zinc-200">48</span>
                                </div>
                                <div className="flex border-t border-white py-2">
                                    <span className="text-zinc-300">Heal</span>
                                ...
                                <div className="flex border-t border-white py-2">
                                    <span className="text-zinc-300">Acceleration</span>
                                    <span className="ml-auto text-zinc-200">14</span>
                                </div>
                                <div className="flex border-t border-white py-2">
                                    <span className="text-zinc-300">Pace</span>
