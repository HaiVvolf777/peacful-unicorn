    ...
    return (
      ...
      />
        ...
        />
            ...
            <div className="text-yellow-200 body-font overflow-hidden">
                <div className="container px-5 py-2 mx-auto">
                    <div className="lg:w-4/5 mx-auto flex flex-wrap">
                        <div className="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
                            <h2 className="text-md font-Belmont font-bold title-font text-blue-700 tracking-widest">Peaceful Unicorn</h2>
                            <h1 className="text-blue-700 text-3xl title-font font-medium mb-4">Unkrainicon</h1>
                            <div className="flex mb-4">
                                <a
                                    className="flex-grow text-zinc-200 border-b-2 border-zinc-200 py-2 text-lg px-1 hover:border-blue-700 hover:text-blue-700">Stats</a>
                            ...
                            <div className="flex border-t border-yellow-200 py-2">
                                <span className="text-red-600">Acceleration</span>
                                <span className="ml-auto text-zinc-200">14</span>
                            </div>
                            <div className="flex border-t border-yellow-200 py-2">
                                <span className="text-red-600">Pace</span>
